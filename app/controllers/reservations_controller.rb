class ReservationsController < ApplicationController
    ...
    def create
       ...
       if @reservation.persisted?
           @payment = Payment.new({
               email: User.find(@reservation.user_id).email, token: params[:payment]["token"], reservation_id: @reservation.id,
        ...
        if @payment.save
           ...
           redirect_to @reservation.room, notice: "Votre réservation à été acceptée"
        end
